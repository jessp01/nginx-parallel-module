# Parallel module for Nginx [![BuildStatus](https://travis-ci.org/kaltura/nginx-parallel-module.svg?branch=master) (https://travis-ci.org/kaltura/nginx-parallel-module)
